        ...
        <div class="bg-gray-50 p-5 rounded-2xl mb-6">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="text-base font-bold text-gray-900">
                    Rp<span x-text="selectedOrderForPayment?.harga ? Number(selectedOrderForPayment.harga).toLocaleString('id-ID') : '0'"></span>
                </span>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <button type="button" 
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400">Bayar dengan GoPay, OVO, ShopeePay, Dana, dll</p>
                        </div>
                    </div>
                    <div class="w-5 h-5 rounded-full border flex items-center justify-center" 
                ...
                <button type="button" 
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-bold text-sm">Bayar Tunai di Lokasi</p>
                            <p class="text-xs text-gray-400">Bayar langsung secara tunai saat pengambilan motor</p>
                        </div>
                    </div>
                    <div class="w-5 h-5 rounded-full border flex items-center justify-center" 
        ...
        <div class="flex gap-3 mt-8">
            ...
            <button type="button" 
                    @click="
                        ...
                        fetch('/daftar-pesanan/' + orderId + '/pay', {
                            method: 'POST',
                            headers: {
                        ...
                        .then(response => {
                            if (!response.ok) throw new Error('Gagal mendapatkan token transaksi.');
                        ...
                        .then(data => {
                            if(data.success) {
                                ...
                                // Jika memilih Tunai, lewati pemanggilan SDK Midtrans Snap
                                if (selectedPaymentMethod === 'Tunai') {
                                    alert(data.message || 'Metode tunai berhasil dipilih!');
                        ...
                        .catch(error => {
                            ...
                            alert('Terjadi masalah jaringan atau konfigurasi server.');
                        });
                    "
