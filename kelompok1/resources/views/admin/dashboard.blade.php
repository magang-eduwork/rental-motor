    ...
    <div class="xl:col-span-2 space-y-6">
        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-around gap-6">
                <!-- Donut Chart Mockup / Total Keseluruhan -->
                ...
                <div class="w-full sm:w-1/2 space-y-2">
                    ...
                    @forelse($topOrderan ?? [] as $index => $item)
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="semibold text-gray-800">{{ $item['total'] }}</span>
                        </div>
                    @empty
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                ...
                <div class="border-t pt-3 space-y-3">
                    <div class="flex justify-between text-sm text-gray-600"><span>Tersedia</span><span class="font-semibold text-gray-800">{{ $kendaraanTersedia ?? 0 }}</span></div>
                    <div class="flex justify-between text-sm text-gray-600"><span>Jumlah bookingan</span><span class="font-semibold text-gray-800">{{ $jumlahBookingan ?? 0 }}</span></div>
                    <div class="flex justify-between text-sm text-gray-600"><span>Sedang disewa</span><span class="font-semibold text-gray-800">{{ $kendaraanDisewa ?? 0 }}</span></div>
                </div>
            </div>
